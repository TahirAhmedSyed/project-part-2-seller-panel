...
const PickupRequest = ({navigation,route}) => {
  const myEmail=route.params.myEmail; 
  const [productdata,setproductdata] = useState("");
  
  var fetchInsertApi="https://cucina.com.pk/api/fetch_pickup_request.php?uemail="+myEmail;
      var headers={
    ...
    const submit= () =>{
     ...
     return(
       <View style={styles.mainscreen}>
        ...
        <View>
            <Text style={{color:"#800080",fontWeight:"bold",fontSize:18,textAlign:"center",}}>Pickup Order Request Detail....!</Text>
        </View>
  ...
  <FlatList 
    ...
    return(
        <View>
          <TouchableOpacity
          onPress={() => navigation.navigate("PickupOrderApprove",{detail_id : element.item.detail_id,myEmail:myEmail})}>
         ...
         <Text style={styles.textstyles2}>PickUp Date : {element.item.pick_date}</Text>
         <Text style={styles.textstyles2}>PickUp Date : {element.item.pick_time}</Text>
