...
const OrderHistory = ({navigation,route}) => {
  ...
  var fetchInsertApi="https://cucina.com.pk/api/fetch_order_history.php?uemail="+myEmail;
      var headers={
    ...
    const submit= () =>{
     ...
     return(
       <View style={styles.mainscreen}>
        ...
        <View>
            <Text style={{color:"#800080",fontWeight:"bold",fontSize:18,textAlign:"center",}}>Order History....!</Text>
        </View>
  ...
  <FlatList 
    ...
    return(
        <View>
         ...
         <Text style={styles.textstyles2}>Order Type : {element.item.shop_type}</Text>
         <Text style={styles.textstyles2}>Order Status : {element.item.order_status}</Text>
